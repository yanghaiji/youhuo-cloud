package com.youhuo.cloud.system.auth.dto;
 ...
 * @since 2023-03-19
 */
@Schema(description = "管理后台 - 账号密码登录 Request DTO")
@Data
@NoArgsConstructor
@AllArgsConstructor
@Builder
public class AuthUserDTO {
    ...
    @Schema(description = "验证码,验证码开启时，需要传递", required = true,
            example = "DETRYULKJohuoiuyUNgLuykbyugUjkiYGIuyGI==")
    @NotEmpty(message = "验证码不能为空", groups = CodeEnableGroup.class)
    private String captchaVerification;

    // ========== 绑定社交登录时，需要传递如下参数 ==========

    @Schema(description = "后期在做", required = true, example = "10")
